...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  Widget withShared(Rooms rooms) {
    ...
    String title = 'Chat';
    if(_currentUser.isTherapist()){
      Therapist? therapistOfRoom = getTherapistFromRoom(rooms.rooms[tabController.index], _currentUser);
      if(therapistOfRoom != null){
        title = AppLocalizations.of(context)!.chatTitleWith(therapistOfRoom.name);
      }
