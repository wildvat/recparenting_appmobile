    ...
    if (pickedDate != null && mounted) {
      ...
      if (picked != null && mounted) {
        final String datetTime =
            '${pickedDate.toString().substring(0, 10)} ${picked.hour < 10
            ? '0${picked.hour}'
            : picked.hour}:${picked.minute < 10 ? '0${picked.minute}' : picked
            .minute}';
                  ...
                  child: ListView(controller: scrollController, children: [
                    ...
                    DropdownButton<String>(
                      ...
                      items: _appointmentTypes
                          .map((e) =>
                          AppointmentTypes.getAppointMentTypeString(e))
                          .toList()
                        ...
                        ElevatedButton(
                            onPressed: _isLoading
                              ...
                              if (response.event != null) {
                                SnackBarRec(context: context,
                                    message: AppLocalizations.of(context)!
                                        .eventCreateMessageOk, backgroundColor: Colors.green);
