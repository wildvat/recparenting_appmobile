        ...
        body: Container(
          ...
          child: event != null
              ? Column(
                  ...
                  children: [
                      TitleDefault(
                        AppLocalizations.of(context)!.generalAddToCalendarTitle,
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 30),
                      ButtonAddCalendar(
                          event: event!, popOnFinish: true, isIcon: false)
                    ])
              : Form(
                  key: _formKey,
                    ...
                    _currentUser.isTherapist()
                        ? TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintStyle:
                                  TextStyle(fontSize: TextSizes.large.size),
                            ...
                            onPressed: _isLoading
                                ...
                                : () async {
                                    ...
                                    if (response.event != null) {
                                      ...
                                      setState(() {
                                        event =
                                            response.event?.event is EventModel
